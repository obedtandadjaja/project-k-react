...
export const ALL_OPEN_BEGIN = 'MAINTENANCE_ALL_REQUESTS_OPEN_BEGIN'
export const ALL_OPEN_SUCCESS = 'MAINTENANCE_ALL_REQUESTS_OPEN_SUCCESS'
export const ALL_OPEN_FAILURE = 'MAINTENANCE_ALL_REQUESTS_OPEN_FAILURE'
