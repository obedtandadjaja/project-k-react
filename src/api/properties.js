...
export function create(data) {
  return dispatch => {
    ...
    return axios.post(`http://${API_HOST}${BACKEND_PROXY_PREFIX}/api/v1/properties`, data).then(
...
export function edit(data) {
  return dispatch => {
    ...
    return axios.put(`http://${API_HOST}${BACKEND_PROXY_PREFIX}/api/v1/properties/${data.id}`, data).then(
...
export function get(data) {
  return dispatch => {
    ...
    return axios.get(`http://${API_HOST}${BACKEND_PROXY_PREFIX}/api/v1/properties/${data}`).then(
